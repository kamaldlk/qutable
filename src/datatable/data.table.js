...
class FixedDataTable extends React.Component {
  ...
  onColumnResize(combinedWidth,leftOffset,cellWidth,cellMinWidth,cellMaxWidth,columnKey,event) {
  ...
  render() {
      ...
      groupHeader = (
        <FixedDataTableRow
          ...
          className={joinClasses(
            cx('fixedDataTableLayoutHeader'),
            cx('publicFixedDataTableHeader'),
          )}
          width={state.width}
    ...
    if (state.footerHeight) {
      footer =
        <FixedDataTableRow
          ...
          isScrolling={this.isScrolling}
          className={joinClasses(
            cx('fixedDataTableLayoutFooter'),
            cx('publicFixedDataTableFooter'),
          )}
          width={state.width}
    ...
    if (state.scrollY) {
      topShadow =
        <div
          className={joinClasses(
            cx('fixedDataTableLayoutTopShadow'),
            cx('publicFixedDataTableTopShadow'),
          )}
